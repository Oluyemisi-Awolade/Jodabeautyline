...
// Free Unsplash images — commercially licensed, no attribution required
const HERO_BG     = 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=1800&q=80&fit=crop'
const MODEL_DARK  = 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=900&q=80&fit=crop'
const MODEL_FAIR  = 'https://images.unsplash.com/photo-1588516903720-8ceb67f9ef84?w=900&q=80&fit=crop'
const ABOUT_BG    = 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=1200&q=80&fit=crop'
    ...
    <>
      ...
      <section className="relative min-h-screen bg-[#0a0806] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src={HERO_BG}
            alt="Joda Beauty Line luxury fragrance"
            fill
            className="object-cover object-top opacity-50"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0a0806] via-[#0a0806]/75 to-[#0a0806]/20" />
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative group overflow-hidden" style={{ aspectRatio: '3/4' }}>
              <Image
                src={MODEL_DARK}
                alt="Dark skin model with Joda Beauty Line Soie d'Or Oud"
                fill
                className="object-cover object-top transition-transform duration-700 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0806] via-[#0a0806]/20 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="font-mono-dm text-[9px] tracking-[0.2em] uppercase text-[#c9973a] mb-2">Her Signature</div>
                ...
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi! I want to order Soie d'Or Oud")}`}
              ...
              <div className="absolute top-6 right-6 w-16 h-24 rounded overflow-hidden shadow-2xl">
                <Image src="/images/soie.jpg" alt="Soie d'Or Oud bottle" fill className="object-cover" />
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden" style={{ aspectRatio: '3/4' }}>
              <Image
                src={MODEL_FAIR}
                alt="Fair skin model with Joda Beauty Line ROS cologne"
                fill
                className="object-cover object-top transition-transform duration-700 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0806] via-[#0a0806]/20 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi! I want to order ROS Cologne")}`}
                  target="_blank" rel="noopener noreferrer"
                  className="inline-block font-mono-dm text-[9px] tracking-[0.2em] uppercase bg-[#c9973a] text-[#0a0806] px-6 py-3 hover:bg-[#e4bc58] transition-colors"
                >
                  Order Now
              ...
              <div className="absolute top-6 right-6 w-16 h-24 rounded overflow-hidden shadow-2xl">
                <Image src="/images/ros.jpg" alt="ROS bottle" fill className="object-cover" />
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[#6b6460] leading-relaxed mb-8">
              From Nigeria to the world, we ship internationally with secure packaging and reliable delivery — because great fragrance has no borders.
            </p>
          ...
          <div className="relative h-[500px]">
            <div className="absolute top-0 right-0 w-3/4 h-3/4 overflow-hidden">
              <Image src={ABOUT_BG} alt="Luxury perfume lifestyle" fill className="object-cover" />
            </div>
            <div className="absolute bottom-0 left-0 w-1/2 h-1/2 overflow-hidden border-4 border-[#faf7f2]">
              <Image src="/images/oud.jpg" alt="Oud Perfume" fill className="object-cover" />
            </div>
      ...
      <section className="py-16 bg-[#faf7f2] border-y border-[#e8e0d0]">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <a
            href="https://www.instagram.com/jodabeautyline?igsh=amVoOTZvZWgya2k5"
            target="_blank" rel="noopener noreferrer"
