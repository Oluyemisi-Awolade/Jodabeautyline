  ...
  return (
    <div className="bg-[#faf7f2] min-h-screen">
      ...
      <div className="bg-[#0a0806] py-16 text-center">
        ...
        <p className="text-[#6b6460] mb-6">Not sure which fragrance is right for you? Message us on WhatsApp — we'll help you choose.</p>
        <a
          href="https://wa.me/2349138479374?text=Hi! I need help choosing a fragrance"
          target="_blank"
